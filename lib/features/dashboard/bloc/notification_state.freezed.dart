...
class _$NotificationStateImpl extends _NotificationState {
  const _$NotificationStateImpl(
      {final List<String> notifications = const <String>[],
  ...
  @override
  String toString() {
    return 'NotificationState(notifications: $notifications, isLoading: $isLoading, unreadCount: $unreadCount, errorMessage: $errorMessage)';
  }
